module ArmoryBot
  module Commands
    module Mercy
      ...
      command([:mercy, :Mercy, :MERCY], bucket: :overwatch, min_args: 3, rate_limit_message: 'All heroes share a rate limit. Wait %time% more seconds.') do |event, *account, region, platform|
        ...
        data = HTTParty.get("https://api.lootbox.eu/#{platform}/#{region}/#{acc}/hero/Mercy/", :verify => false ).parsed_response
