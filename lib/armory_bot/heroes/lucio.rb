module ArmoryBot
  module Commands
    module Lucio
      ...
      command([:lucio, :Lucio, :LUCIO], bucket: :overwatch, min_args: 3, rate_limit_message: 'All heroes share a rate limit. Wait %time% more seconds.') do |event, *account, region, platform|
